...
./alleleNetwork.pl *abr.drs > RWA_Net.abr.net
./alleleNetwork.pl *bac.drs > RWA_Net.bac.net
./alleleNetwork.pl *rel.drs > RWA_Net.rel.net


##### AlleleNetwork Alternative ###############################################

Net.abr = read_delim("~/Dropbox/WRITING/FC_meat_2019/RWA_Rescap_analysis/RWA_Net.abr.net", col_names = FALSE, delim = "\t")
Net.bac = read_delim("~/Dropbox/WRITING/FC_meat_2019/RWA_Rescap_analysis/RWA_Net.bac.net", col_names = FALSE, delim = "\t")
Net.rel = read_delim("~/Dropbox/WRITING/FC_meat_2019/RWA_Rescap_analysis/RWA_Net.rel.net", col_names = FALSE, delim = "\t")
...
reads = read_delim("../RWA_FC_meat_reads.csv", col_names = TRUE, delim = ",")   #### File with the reads count per Sample
...
Full.table = Full.table %>% mutate(RPKM = RPK * 1e6 / nonhost_reads,
                                   UpM = Uniq * 1e6 / nonhost_reads)

write.csv(Full.table, "../RWA_FC_meat_allele_network.csv",row.names = FALSE)
