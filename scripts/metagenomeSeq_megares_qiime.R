...
## Add resistome counts
metadata$resistome_raw_mapped_reads = colSums(MRcounts(AMR_raw_analytic_data[[1]]))

new_AMR_metadata <- pData(AMR_raw_analytic_data[[1]])
new_AMR_metadata$resistome_raw_mapped_reads = colSums(MRcounts(AMR_raw_analytic_data[[1]]))

## Add microbiome counts
...
new_microbiome_metadata$microbiome_domain_Richness = specnumber(t(MRcounts(microbiome_analytic_data[[1]])))
new_microbiome_metadata$microbiome_domain_Shannon = vegan::diversity(t(MRcounts(microbiome_analytic_data[[1]])))

new_microbiome_metadata$microbiome_phylum_Richness = specnumber(t(MRcounts(microbiome_analytic_data[[2]])))
microbiome_metadata$microbiome_phylum_Shannon = vegan::diversity(t(MRcounts(microbiome_analytic_data[[2]])))

microbiome_metadata$microbiome_class_Richness = specnumber(t(MRcounts(microbiome_analytic_data[[3]])))
microbiome_metadata$microbiome_class_Shannon = vegan::diversity(t(MRcounts(microbiome_analytic_data[[3]])))

microbiome_metadata$microbiome_order_Richness = specnumber(t(MRcounts(microbiome_analytic_data[[4]])))
microbiome_metadata$microbiome_order_Shannon = vegan::diversity(t(MRcounts(microbiome_analytic_data[[4]])))

microbiome_metadata$microbiome_family_Richness = specnumber(t(MRcounts(microbiome_analytic_data[[5]])))
microbiome_metadata$microbiome_family_Shannon = vegan::diversity(t(MRcounts(microbiome_analytic_data[[5]])))

microbiome_metadata$microbiome_genus_Richness = specnumber(t(MRcounts(microbiome_analytic_data[[6]])))
microbiome_metadata$microbiome_genus_Shannon = vegan::diversity(t(MRcounts(microbiome_analytic_data[[6]])))

microbiome_metadata$microbiome_species_Richness = specnumber(t(MRcounts(microbiome_analytic_data[[7]])))
microbiome_metadata$microbiome_species_Shannon = vegan::diversity(t(MRcounts(microbiome_analytic_data[[7]])))
